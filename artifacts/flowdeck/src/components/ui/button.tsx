...
" hover-elevate active-elevate-2",
  {
    variants: {
      variant: {
        ...
        destructive:
          "bg-destructive text-destructive-foreground shadow-sm border-destructive-border hover:opacity-90",
        outline:
          "border [border-color:var(--button-outline)] shadow-xs active:shadow-none hover:bg-muted hover:text-foreground",
        secondary:
